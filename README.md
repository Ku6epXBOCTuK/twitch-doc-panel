...
хост из белого списка): расширение грузит их напрямую и рендерит само. Без
бэкендов, без конвертации, без ревью.
...
- Рендер: marked → мини-AST → рекурсивный компонент. Без `{@html}` и
  санитайзеров: строки эскейпит Svelte, картинки только с хостов из белого
  списка, ссылки только http(s) в новой вкладке, непонятные узлы пропускаются.
